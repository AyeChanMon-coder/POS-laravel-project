...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('main#dashboard') }}"><i
                        class="fas fa-fw fa-table"></i><span>Dashboard </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('category#page') }}"><i
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('sale#page') }}"><i class="fa-solid fa-list"></i><span>Sale
                        Information </span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('password#changePage') }}"><i
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated-grow-in"
                                ...
                                @if (Auth::user()->role == 'superadmin')
                                    <a class="dropdown-item" href="{{ route('newAdmin#page') }}">
                                ...
                                <a class="dropdown-item" href="{{ route('password#changePage') }}">
