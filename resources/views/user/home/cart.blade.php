                        ...
                        @foreach ($cartItems as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        class="btn btn-md rounded-circle bg-light border mt-4 btn-remove">
                    ...
                    <div class="bg-light rounded">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <p class="mb-0" id="subtotal">{{ $totalCart }}mmk</p>
                            </div>
                        ...
                        <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                            ...
                            <p class="mb-0 pe-4 " id="finalTotal">{{ $totalCart + 5000 }} mmk</p>
                        </div>
                        <button id="btn-checkout"
                            class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4"
                            type="button" @if (count($cartItems) == 0) disabled @endif>Proceed Checkout</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-checkout').click(function() {
                orderList = [];
                userId = $('.userId').val();
                orderCode = "ACM-POS-" + Math.floor(Math.random() * 1000000000000);
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function(res) {
                        res.status == 'success' ? location.href = '/user/paymentPage' : location
                            .reload()
                    }
                })
            })
