...
<head>
    <meta charset="utf-8">
    <title>Connect Coffee & Cake</title>
    ...
    <link rel="stylesheet" href="{{ asset('user/css/custom.css') }}">
    {{-- user contact css  --}}
    <link rel="stylesheet" href="{{ asset('user/css/userContact.css') }}">
...
<body>
    ...
    <!-- Navbar start -->
    <div class="container-fluid fixed-top sticky-top">

        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.html" class="navbar-brand">
                    <h1 class="text-primary display-6">POS</h1>
                </a>
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="" class="nav-link dropdown-toggle my-auto mt-2" data-bs-toggle="dropdown">
                                <img src="{{ Auth::user()->profile == null ? asset('default/profilePic.jpg') : asset('profile/' . Auth::user()->profile) }}"
